 ...
 */
function custom_wc_od_get_days_by( $days, $property, $value ) {
	$filtered_days = array();
 ...
 */
function custom_wc_od_get_events( $filters = array() ) {
 ...
 */
function custom_wc_od_get_disabled_days( $args = array(), $context = '' ) {
 ...
 */
function custom_wc_od_is_disabled_day( $date, $args = array(), $context = '' ) {
...
add_filter( 'custom_wc_od_is_disabled_day', 'custom_wc_od_is_current_day_disabled', 10, 4 );
 ...
 */
function custom_wc_od_validate_delivery_date( $date, $args = array(), $context = '' ) {
	 ...
	 * @param string $context The context.
	 */
	$args = apply_filters( 'custom_wc_od_validate_delivery_date_args', wp_parse_args( $args, $defaults ), $context );
	 ...
	 * @param string $context            The context.
	 */
	return apply_filters( 'custom_wc_od_validate_delivery_date', $valid, $delivery_timestamp, $args, $context );
}
 ...
 */
function custom_wc_od_get_first_shipping_date( $args = array(), $context = '' ) {
	$defaults = array(
	 ...
	 * @param string $context   The context.
	 */
	return apply_filters( 'custom_wc_od_get_first_shipping_date', $first_shipping_date, $args, $context );
}
 ...
 */
function custom_wc_od_get_last_shipping_date( $args = array(), $context = '' ) {
	$defaults = array(
		'shipping_method'             => false,
		'shipping_days'               => WC_OD()->settings()->get_setting( 'shipping_days' ),
		'delivery_days'               => WC_OD()->settings()->get_setting( 'delivery_days' ),
	...
	error_log(print_r($args['delivery_range'], true));
	error_log(__METHOD__.' : '.print_r($delivery_range, true));
	$days_for_delivery = 0;
	 ...
	 * @param string $context   The context.
	 */
	return apply_filters( 'custom_wc_od_get_last_shipping_date', $last_shipping_date, $args, $context );
}
 ...
 */
function custom_wc_od_get_first_delivery_date( $args = array(), $context = '' ) {
	$defaults = array(
	...
	if ( '' === $args['shipping_date'] ) {
		$args['shipping_date'] = custom_wc_od_get_first_shipping_date( array(), $context );
	}
	 ...
	 * @param string $context   The context.
	 */
	return apply_filters( 'custom_wc_od_get_first_delivery_date', $first_delivery_date, $args, $context );
}
 ...
 */
function custom_wc_od_get_next_delivery_date( $args = array(), $context = '' ) {
	$defaults = array(
		'shipping_method'    => false,
		'delivery_days'      => WC_OD()->settings()->get_setting( 'delivery_days' ),
	 ...
	 * @param string $context   The context.
	 */
	return apply_filters( 'custom_wc_od_get_next_delivery_date', $next_delivery_date, $args, $context );
}
